...
#     with open('data_0422_col_row_switch_module_%s.pickle' %module_num, 'r') as infile:
#         sim_out = pickle.load(infile)
...
#    
# plt.subplot(212)
# plt.plot(range(27), data_loss, 'r*')
# plt.ylabel('%')
# plt.xlabel('Module')
# plt.title('Total data loss')
#    
...
# plt.hist(clusters_1['n_hits'], bins = 19, range = [1, 20], histtype = 'step', color = 'k', label = 'Module 1')
...
# plt.hist(clusters_13['n_hits'], bins = 19, range = [1, 20], histtype = 'step', color = 'r', label = 'Module 13')
# plt.hist(clusters_26['n_hits'], bins = 19, range = [1, 20], histtype = 'step', color = 'b', label = 'Module 26')
